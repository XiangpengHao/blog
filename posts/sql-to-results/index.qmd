...
Having the boundaries well-defined, this document aims to explain how query engines (i.e., [OLAP](https://aws.amazon.com/compare/the-difference-between-olap-and-oltp)) transform a plain SQL query into the results we want, how every step works, and how they are connected.
```{mermaid}
flowchart LR
