...
## Preface 
Database can be complex, it involves almost all aspects (research communities) of computer science: PL (programming language), SE (software engineering), OS (operating system), networking, storage, theory, and more recently, NLP (natural language processing), and ML (machine learning). 
